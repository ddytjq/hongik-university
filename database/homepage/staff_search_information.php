...
if($A=="" and $B=="" and $C=="" and $D=="" and $E=="" and $F=="" and $G=="" and $H=="" and $I==""){
	$query = "select * from EMP_MANAGEMENT";
}
else{
	$query = "select * from EMP_MANAGEMENT where EMP_ID='$A' or EMP_NAME='$B' or EMP_SEX = '$C' or EMP_AGE ='$D' or EMP_POST_NUM='$E' or EMP_POST='$F' or EMP_TEL_NUM='$G' or EMP_MOB_NUM='$H' or EMP_RANK='$I'";
}
	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul><strong>
				...
				<li class="current_page_item"><a href="staff.html" accesskey="4" title="">Staff</a></li>
