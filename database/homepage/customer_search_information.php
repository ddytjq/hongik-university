...
if($A=="" and $B=="" and $C=="" and $D=="" and $E=="" and $F=="" and $G=="" and $H==""){
	$query = "select * from CUS_MANAGEMENT";
}
else{
	$query = "select * from CUS_MANAGEMENT where CUS_ID='$A' or CUS_NAME='$B' or CUS_SEX = '$C' or CUS_AGE ='$D' or CUS_POST_NUM = '$E' or CUS_POST = '$F' or CUS_TEL_NUM = '$G' or CUS_MOB_NUM = '$H'";
}
	...
	<div id="header" class="container">
		...
		<div id="menu">
			<ul><strong>
				...
				<li class="current_page_item"><a href="customer.html" accesskey="3" title="">Customer </a></li>
