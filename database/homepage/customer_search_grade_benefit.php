...
if($A=="" and $B=="" and $C=="" and $D=="" and $E==""){
	$query = "select * from CUS_GRADE_BENEFIT";
}
else{
	$query = "select * from CUS_GRADE_BENEFIT where CUS_ID='$A' or CUS_RANK='$B' or CUS_TOTAL_ORDER = '$C' 
	or CUS_COUPON ='$D' or CUS_SAVE_MONEY = '$E'";
}
